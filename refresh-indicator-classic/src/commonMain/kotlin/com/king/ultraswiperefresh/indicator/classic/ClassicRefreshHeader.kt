...
import com.king.ultraswiperefresh.indicator.classic.generated.resources.usr_classic_arrow
import com.king.ultraswiperefresh.indicator.classic.generated.resources.usr_classic_spinner
...
fun ClassicRefreshHeader(
    ...
    tipTime: @Composable () -> String = {
        obtainLastActiveTime(
            isActive = state.headerState == UltraSwipeHeaderState.Refreshing,
            prefixRes = Res.string.usr_last_refresh_time,
        )
    },
