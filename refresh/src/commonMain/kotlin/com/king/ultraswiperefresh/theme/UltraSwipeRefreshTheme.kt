...
data class UltraSwipeRefreshConfig(
    ...
    val refreshTriggerRate: Float = 1f,
    val loadMoreTriggerRate: Float = 1f,
    ...
    val headerSecondaryTriggerRate: Float = 2f,
    val footerSecondaryTriggerRate: Float = 2f,
    val headerMaxOffsetRate: Float = 3f,
    val footerMaxOffsetRate: Float = 3f,
    val dragMultiplier: Float = 0.5f,
    val finishDelayMillis: Long = 500,
    val vibrationEnabled: Boolean = false,
    val vibrationMillis: Long = 25,
